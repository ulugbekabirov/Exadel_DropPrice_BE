...
namespace BL.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<IEnumerable<DiscountDTO>> GetDiscountsAsync(SortModel sortModel, User user)
        {
            ...
            var closestDiscounts = _discountRepository.GetClosestActiveDiscountsAsync(location, int.Parse(radius.Value));
        ...
        public async Task<IEnumerable<DiscountDTO>> SearchDiscountsAsync(SearchModel searchModel, User user)
        {
            ...
            var discounts = _discountRepository.SearchDiscounts(searchModel.SearchQuery, searchModel.Tags, location, int.Parse(radius.Value));
        ...
        public async Task<IEnumerable<DiscountStatisticDTO>> SearchDiscountsForStatisticsAsync(AdminSearchModel adminSearchModel)
        {
            ...
            var sortBy = (Sorts)Enum.Parse(typeof(Sorts), adminSearchModel.SortBy[0]);
            var thenSortBy = (Sorts)Enum.Parse(typeof(Sorts), adminSearchModel.SortBy[1]);
