...
namespace DAL.Interfaces
{
    public interface IVendorRepository : IRepository<Vendor>
    {
        ...
        IOrderedQueryable<Vendor> SortBy(IQueryable<Vendor> vendors, Sorts sortBy);

        IOrderedQueryable<Vendor> ThenSortBy(IOrderedQueryable<Vendor> vendors, Sorts sortBy);
    }
}
